...
{
    public function __invoke(int | string $offer_id, int | string $user_id, Request $request, DocumentsRepository $documentsRepository, EntityManagerInterface $em): JsonResponse
    {
