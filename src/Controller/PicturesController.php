...
{
    public function __invoke(int | string $user_id, int | string $vehicle_id, Request $request, PicturesRepository $picturesRepository, VehiclesRepository $vehiclesRepository, EntityManagerInterface $em): JsonResponse
    {
